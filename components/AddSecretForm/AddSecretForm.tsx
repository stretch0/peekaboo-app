  ...
  return (
    <>
      ...
      >
        ...
        <div 
          className="flex flex-row gap-0 items-center w-full max-w-2xl mx-auto mt-8 justify-center"
        >
          {shareUrl && (
            <>
              <input 
                className="flex-grow p-4 text-lg bg-gray-100 rounded-l-lg text-black focus:outline-none dark:bg-gray-800 dark:text-white overflow-ellipsis border-2 border-indigo-400 border-r-0"
                value={shareUrl}
                readOnly
              />
              <button
                className="p-4 text-lg font-semibold text-white bg-black rounded-r-lg dark:text-white dark:bg-gray-600 dark:hover:bg-gray-700 dark:hover:text-white hover:bg-gray-100 hover:text-black focus:outline-none flex-shrink-0 border-2 border-indigo-400 border-l-0"
                onClick={() => {
                  handleCopy(shareUrl)
                }}
              >
